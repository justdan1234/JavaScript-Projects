...
function placeXOrO(squareNumber) {
    ...
    if (!selectedSquares.some(element => element.includes(squareNumber))) {
        ...
        let select = document.getElementById(sqyareNumber);
        //This condition checks who's turn it is
        if (activePlayer === 'X') {
            //If activePlayer is equal to 'X' the x.png is placed in the html
            select.style.backgroundImage = 'url("images/x.png")';
            //Active player may only be 'X' or 'O'
        } else {
            //If activePlayer is equal to 'O' o.png is placed in the html
            select.style.backgroundImage = 'url("images/o.png")';
        }
        //squareNumber and activePlayer are concatenated together and added to an array
        selectedSquares.push(squareNumber + activePlayer);
        //This calls a function to check with conditions
        chicWinConditions();
        ...
        //returning true is needed for our cumputerTurn() function to work
        return true;
    }
    ...
    function computersTurn() {
        ...
        let pickASquare;
        //this condition allows our while loop to keeep trying if a sqaure is selected already
        while (!sucess) {
...
function checkWinConditions() {
    ...
    function array(squareA, squareB, squareC) {
        //These 3 variables will be used to check for 3 in a row
        const a = selectedSquares.includes(squareA);
        const b = selectedSquares.includes(squareB);
        const C = selectedSquares.includes(squareC);
        //If the 3 variables we pass are all included in our array and then true is returned and our else if condition executes the drawLine() function
...
function disableClick() {
    ...
    //This makes our body clickable again afte 1 second
    setTimeout(function () { Body.style.pointerEvents = 'auto'; }, 1000);
}


//This function takes a string parameter of the path you set earlier for placement sound ('./media.mp3')
...
function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
    ...
    let x1 = coordX1,
        ...
        y = y1;
    //This functiom interacts with the canvas
...
function resetGame() {
    ...
    //This resets our array sop it is empty and we can start over
    selectedSquares = [];
}